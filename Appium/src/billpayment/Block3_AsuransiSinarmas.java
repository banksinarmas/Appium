...
public class Block3_AsuransiSinarmas {
	...
	public void Test01_After_Login_Page() throws Exception
	{
		...
		wait30.until(ExpectedConditions.presenceOfElementLocated(By.className("android.widget.EditText"))).sendKeys("asuransi ");

		wait10.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Asuransi Sinarmas']"))).click();
	...
	{		
		...
		driver.findElement(By.className("android.widget.EditText")).sendKeys("12345678901234");;
	...
	{
		wait30.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Select account'] | //*[@text='Pilih akun']"))).click();
		...
		inputFields.get(0).sendKeys("20000");
	...
	public void Test05_Block3_Asuransi_Sinarmas_EasyPin_Page() throws Exception
	{
	...
	@Test(dependsOnMethods="Test05_Block3_Asuransi_Sinarmas_EasyPin_Page")
	public void Test06_Block3_Asuransi_Sinarmas_Result_Page() throws Exception
	{
