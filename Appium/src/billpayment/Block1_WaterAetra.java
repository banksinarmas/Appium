...
public class Block1_WaterAetra {
	...
	{		
		...
		wait10.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='PAM Aetra']"))).click();
		
		wait10.until(ExpectedConditions.presenceOfElementLocated(By.className("android.widget.EditText"))).sendKeys("400099899");
	...
	{
		wait30.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Please select an account'] | //*[@text='Pilih akun']"))).click();
	...
	{
		wait30.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='PAYMENT SUMMARY'] | //*[@text='Ringkasan pembelian']")));
	...
	public void Test05_Block1_Water_Aetra_EasyPin_Page() throws Exception
	{
	...
	@Test(dependsOnMethods="Test05_Block1_Water_Aetra_EasyPin_Page")
	public void Test06_Block1_Water_Aetra_Result_Page() throws Exception
	{
