...
public class TransferOtherbank extends DeviceSetup{
	...
	public TransferOtherbank(String fromAccountType,String toAccountType,String transferMethod,String amount,String desc) throws IOException {	

		this(DEFAULT_PROPERTIES.getProperty("DEF_AUTOMATION_USERNAME"),fromAccountType,toAccountType,transferMethod,amount,desc);
	}
