...
public class Schedule_TransferOtherbank extends DeviceSetup {
	...
	public Schedule_TransferOtherbank(String fromAccountType,String toAccountType,String transferMethod,String amount,String desc,String recurrence,String frequency) throws IOException {
		
		this(DEFAULT_PROPERTIES.getProperty("DEF_AUTOMATION_USERNAME"),fromAccountType,toAccountType,transferMethod,amount,desc,recurrence,frequency);
	}
