...
public class TransferNetwork extends DeviceCapabilities{
	...
	public void Test06_Transfer_Network_EasyPin_Page() throws Exception
	{
		EasyPin_component.input(easyPin);

	}
	@Test(dependsOnMethods="Test06_Transfer_Network_EasyPin_Page")
	public void Test07_Transfer_Network_Result_Page() throws Exception
	{
